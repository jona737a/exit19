<template>
    <div >
        ...
        <div class="video container">
            <iframe id="video" src="https://www.youtube.com/embed/7CiMQpclPKQ" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
        </div>
    </div>
</template>
